...
namespace Arcus.Templates.AzureFunctions.Databricks
{
    ...
    /// </summary>
    public class DatabricksMetricFunction
    {
        private readonly IConfiguration _configuration;
        private readonly ISecretProvider _secretProvider;

        /// <summary>
        /// Initializes a new instance of the <see cref="DatabricksMetricFunction"/> class.
        /// </summary>
        ...
        public DatabricksMetricFunction(IConfiguration configuration, ISecretProvider secretProvider)
        {
