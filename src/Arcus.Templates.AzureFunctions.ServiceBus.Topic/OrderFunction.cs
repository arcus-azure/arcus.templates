...
namespace Arcus.Templates.AzureFunctions.ServiceBus.Topic
{
    ...
    public class OrderFunction
    {
        ...
        {
            Guard.NotNull(messageRouter, nameof(messageRouter), "Requires an message router instance to route the incoming Azure Service Bus topic message through the order processing");
